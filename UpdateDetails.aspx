                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong> Updation Form</strong></h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
                                ...
                                <form id ="UpdationForm" runat="server"  method="get" action ="#">
                                    <div>
                                	...
                                	<div class="form-group">
                                        <div class = "row">
                                            ...
                                            <div class="col-md-4">
			                    		        <asp:TextBox runat="server" ID="MiddleNameTxt" CssClass="form-username form-control" AutoPostBack="False"><</asp:TextBox>
			                                </div>
                                        </div>
                                        <div class="row">
                                            &nbsp;
                                       ...
                                       <div class="row">
                                           <asp:HiddenField runat="server" ID ="PlayerIdHide"></asp:HiddenField>
                                        </div>
                                       <div class ="row">
			                               <div class="col-md-4">
			                                    <asp:button type="submit" runat="server" Text= "Update" ID="Updatesubmit" CssClass="mybtn" OnClick="Updatesubmit_Click"></asp:button>
                                           </div>
                                            <div class="col-md-4">
			                                    <asp:button type="submit" runat="server" Text= "Delete" ID="DeleteButton" CssClass="mybtn" OnClick="DeleteButton_Click"></asp:button>
                                           </div>
                                            <div class="col-md-4">
			                                    <asp:button type="submit" runat="server" Text= "Back" ID="BackButton" CssClass="mybtn" OnClick="BackButton_Click"></asp:button>
                                           </div>
